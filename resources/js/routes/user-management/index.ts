...
* @see app/Http/Controllers/UserManagementController.php:29
* @route '/user-management'
*/
...
* @see app/Http/Controllers/UserManagementController.php:38
...
* @see app/Http/Controllers/UserManagementController.php:53
* @route '/user-management/{user}'
*/
