...
* @see app/Http/Controllers/ApprovalController.php:15
* @route '/approvals'
*/
...
* @see app/Http/Controllers/ApprovalController.php:38
...
* @see app/Http/Controllers/ApprovalController.php:47
