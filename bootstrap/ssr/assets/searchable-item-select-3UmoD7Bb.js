...
//#region resources/js/components/searchable-item-select.tsx
function SearchableItemSelect({ value, items, onChange, placeholder = "Cari kode atau nama item", emptyOptionLabel, entityLabel = "item" }) {
	...
	const filteredItems = items.filter((item) => `${item.code} ${item.name}`.toLowerCase().includes(query.trim().toLowerCase())).slice(0, 50);
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Search, { className: "pointer-events-none absolute left-3.5 top-3.5 z-10 size-4 text-slate-400" }),
			/* @__PURE__ */ jsx("input", {
				value: query,
				autoComplete: "off",
				placeholder,
			...
			query || value ? /* @__PURE__ */ jsx("button", {
				type: "button",
			...
			}) : /* @__PURE__ */ jsx(ChevronDown, { className: `pointer-events-none absolute right-3.5 top-3.5 size-4 text-slate-400 transition ${open ? "rotate-180" : ""}` }),
			open && /* @__PURE__ */ jsxs("div", {
				...
				children: [emptyOptionLabel && /* @__PURE__ */ jsxs("button", {
					type: "button",
					onMouseDown: (event) => event.preventDefault(),
					onClick: () => {
						onChange("");
					...
					children: [emptyOptionLabel, !value && /* @__PURE__ */ jsx(CheckCircle2, { size: 15 })]
				}), filteredItems.length ? filteredItems.map((item) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					onMouseDown: (event) => event.preventDefault(),
					onClick: () => {
					...
					children: [/* @__PURE__ */ jsxs("span", { children: [
						...
						" — ",
						item.name
					] }), String(item.id) === String(value) && /* @__PURE__ */ jsx(CheckCircle2, { size: 15 })]
				}, item.id)) : /* @__PURE__ */ jsxs("p", {
					className: "px-3 py-6 text-center text-xs text-slate-500",
					children: [entityLabel.charAt(0).toUpperCase() + entityLabel.slice(1), " tidak ditemukan."]
				})]
			})
		]
	});
...
//#endregion
export { SearchableItemSelect as t };

//# sourceMappingURL=searchable-item-select-3UmoD7Bb.js.map